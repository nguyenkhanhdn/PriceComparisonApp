...
namespace PriceComparisonApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Branch,Category,ImgUrl,Memory,Price,Rate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Branch,Category,ImgUrl,Memory,Price,Rate")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
